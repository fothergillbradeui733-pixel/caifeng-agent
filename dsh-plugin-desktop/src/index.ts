...
export function apply(ctx: Context, config: Config): void {
  ...
  if (runtime === undefined) {
    process.stderr.write(
      'dsh-plugin-desktop: this profile is composed with the 才丰 Agent shell, which requires the desktop launcher (desktopRuntime).\n'
      + 'Start it with `dsh-desktop`, or select this profile inside the packaged 才丰 Agent application.\n'
