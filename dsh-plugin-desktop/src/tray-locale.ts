...
const labels: Record<DesktopLocale, Record<DesktopTrayLabelKey, (value: string) => string>> = {
  en: {
    ...
    downloadingUpdate: version => `Downloading 才丰 Agent ${version}…`,
    ...
    updateAvailable: version => `才丰 Agent ${version} Available`,
  },
  zh: {
    checkForUpdates: () => '检查更新…',
    checkingForUpdates: () => '正在检查更新…',
    downloadingUpdate: version => `正在下载 才丰 Agent ${version}…`,
    ...
    updateAvailable: version => `才丰 Agent ${version} 可用`,
  },
}
