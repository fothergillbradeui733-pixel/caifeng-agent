...
export const DESKTOP_VERSION_ENDPOINT = 'https://api.github.com/repos/fothergillbradeui733-pixel/caifeng-agent/releases/latest'
...
function parseVersionResponse(body: string): ParsedSemVer | null {
  ...
  return parseCanonicalStableVersion(version)
}
