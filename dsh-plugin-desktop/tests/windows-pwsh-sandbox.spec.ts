...
const adaptation: WindowsAclAdaptation = {
  platform: 'win32',
  electron: true,
  execPath: 'C:\\Program Files\\才丰 Agent\\才丰 Agent.exe',
  upstreamRunner: 'C:\\Program Files\\才丰 Agent\\resources\\app.asar\\runner.js',
  trampoline: 'C:\\Program Files\\才丰 Agent\\resources\\app.asar\\desktop-runner.js',
}
